...
- Создать/редактировать профиль
	- Создание профиля:
		- Описание:
			Сотрудник выбирает «Создать профиль» -> далее заполняет, необходимые поля. При создании профиля каждому пользователю, присваивается уникальный ID
		- Поля для профиля сотрудник-водитель
			- Имя*
			- Фамилия
			- Номер телефона
	...
	- Редактирование профиля
		- Описание
			Сотрудник выбирает -> «Редактировать профиль». Происходит переход в в первое поле (Имя), далее по порядку.
	- Мой автомобиль
		- Описание
		...
		- Кнопки
			...
			- Удалить
				...
				📝 Вы действительно хотите удалить данный автомобиль?
				- После нажатия кнопки «Подтвердить»:
				
				📝Ваш автомобиль удалён, чтобы пользоваться сервисом без ограничений, создайте новый в меню
				- Кнопки
					- Подтвердить
					- Назад
			- Назад
	- Удаление профиля
		- Описание
			Сотрудник открывает бота, бот отправляет доступные команды -> сотрудник выбирает -> далее «Мой профиль» -> далее выбирает «Удалить профиль», бот отправляет сотруднику предупреждение о невозможности восстановления данных:
			
			📝 Вы действительно хотите удалить данный профиль?
			- После нажатия кнопки «Подтвердить»:
				
				📝Ваш профиль удалён, чтобы пользоваться сервисом без ограничений, создайте новый в главном меню
		- Кнопки
			- Подтвердить
			- Назад
	- Кнопки
